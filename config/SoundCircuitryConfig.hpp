#ifndef SOUND_CIRCUITRY_CONFIG_HPP
#define SOUND_CIRCUITRY_CONFIG_HPP

#include <string>

namespace SoundCircuitryConfig {
    const std::string firstFleetMovementPath{"../sound/first_fleet_movement.wav"};
    const std::string secondFleetMovementPath{"../sound/second_fleet_movement.wav"};
